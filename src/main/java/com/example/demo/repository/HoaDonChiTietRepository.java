...
//
//    @Query(value = "select sum(tong_tien_da_giam) from hoa_don where ((loai_hd=1 and trang_thai=1) or (loai_hd=0 and trang_thai = 3) or (loai_hd=0 and trang_thai=3 and hinh_thuc_thanh_toan=1))",nativeQuery = true)
