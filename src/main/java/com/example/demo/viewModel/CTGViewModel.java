...
public class CTGViewModel {
    ...
    public CTGViewModel(UUID idMau,UUID idGiay, Double minPriceTruocGiam, Double minPrice, String tenGiay, String tenMau, Long slTon, String hinhAnh, Long soLuongDaBan, Date tgNhapHang) {
        this.idMau = idMau;
        this.idGiay = idGiay;
